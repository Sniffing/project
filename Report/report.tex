...
\begin{figure}[!ht]
	...
	\begin{subfigure}[t]{.4\textwidth}
		\centering
		\includegraphics[scale=0.1]{pics/landscapeARNoPaper.png}
	...
	\begin{subfigure}[t]{.4\textwidth}
		\centering
		\includegraphics[scale=0.1]{pics/landscapeARNoPaper2.png}
		\caption{The user must align their paper properly}
	...
	\begin{subfigure}[t]{.4\textwidth}
		\centering
		\includegraphics[scale=0.1]{pics/landscapeARTooFar.png}
	...
	\begin{subfigure}[t]{.4\textwidth}
		\centering
		\includegraphics[scale=0.1]{pics/landscapeARtopdown.png}
	...
	\begin{subfigure}[t]{.4\textwidth}
		\centering
		\includegraphics[scale=0.1]{pics/landscapeARangled.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.2]{pics/sandbox.jpg}
...
The key part of creating the dynamic, self-updating environment that this 
project focuses on is determining when it is time to update. The reason for this
is that there should be an interval between a scene update that is not too frequent
such that it imposes a large amount of computation on the system. In addition, 
we do not want it so infrequent that even after the user draws a new contour, there 
is still time before the recomputation occurs as this will take away from the
real-time component whichh is so fundamental to Augmented Reality. A better
way of choosing the time to update the 3D scene is to try determine \textit{when}
there has been a change in the landscape map.\\
\\ 
As mentioned earlier, the way I have chosen to do this is through a comparison
of captured frames to an identified base frame. When there has been enough
difference captured, we can say that there has been a suitable time to update the
3D scene and the base frame. However, the key here is to decide when we should 
actually update the base frame. There can be a massive change in the scene which
