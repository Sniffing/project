...
\subsubsection{~DO~ Detecting Stabilisation}
...
\While{Camera is open}{
	...
	\uIf{changesPixels $> FRAME\_CHANGE\_THRESHOLD$}{
		PotentialNewFram $\longleftarrow$ thisFrame\;
		PotentialChange $\longleftarrow true$\;
	}\uElseIf{PotentialChange is false}{
		StabilisedCounter++\;
...
The logic behind the algorithm is rather simple. From the base frame,
each subsequent frame has the potential to become the new base frame should
there be enough change between the two.
